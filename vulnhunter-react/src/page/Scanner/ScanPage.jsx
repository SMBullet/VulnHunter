...
const ScanPage = () => {
  ...
  return (
    <div>
      ...
      {/* Scan Results */}
      {scanResult && (
        <div ref={scanResultsRef} className="flex flex-col items-center justify-center min-h-screen p-6 bg-gray-800 text-white">
          <div className="w-full max-w-4xl bg-gray-900 p-8 rounded-lg shadow-lg border border-gray-700">
            ...
            <p className="text-lg mb-6">Here are the results for your recent scan.</p>
